			...
			<div class="grid-9 grid-phone-12">
				<div class="about-header__title">
					...
					<div class="about-header__title-fact">
						<p><span>></span><b>500 000</b> тонн</p>
					</div>
				...
				<div class="grid-6 grid-phone-12">
					<div class="about-info__text-col fade-top">
						<div class="about-info__text user-content">
							<h3>MIRTASH – команда профессионалов, которая гарантирует качество изделий.</h3>
							<p>Компания MIRTASH – часть холдинга, который занимается добычей, обработкой и продажей природного камня. Мы предлагаем изделия из доломита, лемезита и других пород камня.</p>
							<p>Компания работает по всей России. В нашем распоряжении собственное производство, на котором мы изготавливаем более 50 наименований продукции. У нас всегда есть складские запасы, благодаря которым вам не придется ждать производство партии. Вы всегда можете приехать и забрать то, что вам необходимо.</p>
							<h5>РАБОТАЕМ ПО ВСЕЙ РОССИИ, ДОСТАВЛЯЕМ ПРОДУКЦИЮ ДО ОБЪЕКТА</h5>
						</div>
	...
	<div class="about-gallery">
		...
		<div class="about-gallery__slider">
			<div class="about-gallery__slide">
				<img src="<?=SITE_TEMPLATE_PATH?>/img/about-slide-1.jpg" alt="">
			</div>
			<div class="about-gallery__slide">
				<img src="<?=SITE_TEMPLATE_PATH?>/img/about-slide-1.jpg" alt="">
			</div>
		...
		<div class="row row--middle work-proccess">
			<div class="grid-4 grid-phone-12 work-proccess__item-wrap">
				<div class="work-proccess__item fade-top">
					...
					<div class="work-proccess__item-text user-content">Специалисты проводят геологическую разведку и ищут, где скрывается крупный пласт с подходящим для обработки камнем.</div>
				</div>
			</div>
			<div class="grid-4 grid-phone-12 work-proccess__item-wrap">
				<div class="work-proccess__item fade-top">
					...
					<div class="work-proccess__item-text user-content">Рабочие на карьере вскрывают месторождение и приступают к добыче камня. Часть материала станет щебнем. Тот пласт, который слоится, отправляется на сортировку и обработку.</div>
				</div>
			</div>
			<div class="grid-4 grid-phone-12 work-proccess__item-wrap">
				<div class="work-proccess__item fade-top">
					...
					<div class="work-proccess__item-text user-content">Мы делим камень по виду, размеру и толщине. Тонкие пластины подойдут для облицовки и отделки. Толстые – для мощения. Валуны пригодятся тем, кто занимается ландшафтным дизайном, а щебень подойдет для строительства дорог.</div>
				</div>
			</div>
			<div class="grid-4 grid-phone-12 work-proccess__item-wrap">
				<div class="work-proccess__item fade-top">
					...
					<div class="work-proccess__item-text user-content">Полученный и отсортированный камень нужно нарезать на популярные позиции примерно одной длины и толщины с допустимой погрешностью. Мы изготавливаем их по каталогу или нарезаем на заказ.</div>
				</div>
			</div>
			<div class="grid-4 grid-phone-12 work-proccess__item-wrap">
				<div class="work-proccess__item fade-top">
					...
					<div class="work-proccess__item-text user-content">Готовая продукция выставляется на нашем складе. Вы можете в любое время зарезервировать и забрать партию нужного объема. </div>
				</div>
			</div>
		</div>
		<div class="center-btn">
			<p>Закажите необходимую продукцию в нашем каталоге и уже завтра мы сможем её отгрузить</p>
