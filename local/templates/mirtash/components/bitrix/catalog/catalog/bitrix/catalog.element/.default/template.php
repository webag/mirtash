						...
						<? if (!empty($arResult["PROPERTIES"]["PHOTOS"]["VALUE"])) : ?>
							<div class="cart__gallery">
								<? foreach ($arResult["PROPERTIES"]["PHOTOS"]["VALUE"] as $key => $photo_id) : ?>
									...
									?>
									<a href="<?= $photo_big['src'] ?>" data-fancybox="gal-1"><img
												  src="<?= $photo_small['src'] ?>" alt="<?= $arResult["NAME"] ?>"></a>
								<? endforeach; ?>
							</div>
						<? endif; ?>
					...
					<div class="cart__sidebar">
						...
						<div class="cart__short">
							<? if (!empty($arResult["DETAIL_PICTURE"]["SRC"])) : ?>
								...
								?>
								<a href="<?= $arResult["DETAIL_PICTURE"]["SRC"] ?>" data-fancybox><img
											  src="<?= $detail_img['src'] ?>" alt="<?= $arResult["NAME"] ?>"></a>
							<? endif; ?>
						...
						<div class="cart__form-wrap">
							<div class="cart__form">
								<form class="ajax-form">
									...
									<input type="text" class="input-text input-text--bordered" name="user_name"
											 placeholder="Ваше имя" data-label="Имя пользователя">
									<input type="tel" class="input-text input-text--bordered" name="user_phone"
											 placeholder="Номер телефона*" data-label="Телефон" data-req="true">
									<input type="email" class="input-text input-text--bordered" name="user_email"
											 placeholder="E-mail" data-label="E-mail">
									...
									<input type="text" class="input-text input-text--bordered" name="user_num"
											 data-label="Количество" placeholder="Количество">
									<div class="center-btn">
										<button class="btn btn--submit btn--full">заказать</button>
									</div>
									<input type="hidden" value="Новая заявка" name="form_subject">
									<input type="hidden" value="<?= $arResult['NAME'] ?>" name="user_product"
											 data-label="Продукт">
								</form>
							</div>
	...
	<div class="wrapper">
		<div class="row form-callback">
			<div class="grid-7 grid-tabvert-6 grid-phone-12 form-callback__left">
				...
				<img class="form-callback__stone form-callback__stone--cart" data-src="img/form-stone-main.png"
					  data-src-phone="" src="<?= SITE_TEMPLATE_PATH ?>/img/form-stone-main.png" alt="">
			</div>
			<div class="grid-5 grid-tabvert-6 grid-phone-12 form-callback__right">
				<div class="form-wrap">
					<div class="form">
						<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 132.5 139.8" class="stone stone__5"
							  stroke="#017b62" stroke-width="2px" fill="none" width="133" height="140">
							<polyline class="s5_1"
										 points="38.7,46.9 70.2,40.9 131.5,105 62.2,103 1,104.2 38.7,46.9 22.5,24.7 76.4,1 131.5,105 69.2,132.7 1,104.2 22.5,24.7 76.4,1 70.2,40.9 62.2,103 69.2,132.7"/>
							<polyline class="s5_2 hid"
										 points="84.2,60.2 115.7,53.4 131.5,104.7 67.3,110.8 28.6,109 84.2,60.2 59,37.3 130.2,8.3 131.5,104.7 68.2,138.8 28.6,109 59,37.3 130.2,8.3 115.7,53.4 67.3,110.8 68.2,138.8"/>
							<polyline class="s5_3 hid"
										 points="66.6,83 92.1,62.6 130.8,95.4 70.3,113.1 29.3,112.6 66.6,83 53.8,48.3 91.6,23.4 130.8,95.4 70.6,138.8 29.3,112.6 53.8,48.3 91.6,23.4 92.1,62.6 70.3,113.1 70.6,138.8"/>
						</svg>
						<h3>Оставьте ваши контактные данные</h3>
						<p>Специалист свяжется с вами в ближайшее время</p>
						<form class="ajax-form">
							<input type="text" class="input-text" name="user_name" placeholder="Ваше имя"
									 data-label="Имя пользователя">
							<input type="tel" class="input-text" name="user_phone" placeholder="Номер телефона*"
									 data-label="Телефон" data-req="true">
							<input type="email" class="input-text" name="user_email" placeholder="E-mail*" data-label="E-mail"
									 data-req="true">
							<input type="hidden" value="Новая заявка" name="form_subject">
